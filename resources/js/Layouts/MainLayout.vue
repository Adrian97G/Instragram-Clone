    ...
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[61px] border-b border-b-gray-300">
            <div class="flex items-center justify-between h-full">
                <Link href="/">
                    <img class="w-[105px] ml-1 cursor-pointer" src="/insta-logo.png">
                </Link>
        ...
        <div id="SideNav" class="fixed h-full bg-white xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300">
            ...
            <div class="px-3">
                <Link href="/">
                    <MenuItem iconString="Home" class="mb-0"/>
                </Link>
                ...
                <MenuItem @click="$EVENT => showCreatePost = true" iconString="Create" class="mb-3"/>
                <Link href="/user">
                    <MenuItem iconString="Profile" class="mb-3"/>
                </Link>
            </div>

            <Link href="/login" class="absolute bottom-0 px-3 w-full">
                <MenuItem iconString="Log out" class="mb-0"/>
            </Link>
        </div>
        ...
        <div class="flex lg:justify-between bg-white h-full w-[100%-280px] xl:pl-[280px] lg:pl-[100px] overflow-auto">
            ...
            <div v-if="$page.url === '/'" id="SuggestionsSection" class="lg:w-4/12 hidden lg:block text-black mt-9">
                <Link href="/" class="flex items-center justify-between max-w-[300px]">
                    <div class="flex items-center">
                        <img class="rounded-full z-10 w-[58px] h-[58px]" src="https://picsum.photos/id/75/300/320">
                        <div class="pl-4">
                ...
                <Link href="/" class="flex items-center justify-between max-w-[300px] pb-2">
                        <div class="flex items-center">
                            <img class="rounded-full z-10 w-[37px] h-[37px]" src="https://picsum.photos/id/51/300/320">
                            <div class="pl-4">
                                <div class="text-black font-extrabold">Name Here</div>
                                <div class="text-gray-500 text-extrabold text-sm">Name Here</div>
                            </div>
                ...
                </Link> <Link href="/" class="flex items-center justify-between max-w-[300px] pb-2">
                        <div class="flex items-center">
                            <img class="rounded-full z-10 w-[37px] h-[37px]" src="https://picsum.photos/id/52/300/320">
                            <div class="pl-4">
                                <div class="text-black font-extrabold">Name Here</div>
                                <div class="text-gray-500 text-extrabold text-sm">Name Here</div>
                            </div>
                ...
                <Link href="/" class="flex items-center justify-between max-w-[300px] pb-2">
                        <div class="flex items-center">
                            <img class="rounded-full z-10 w-[37px] h-[37px]" src="https://picsum.photos/id/53/300/320">
                            <div class="pl-4">
                                <div class="text-black font-extrabold">Name Here</div>
                                <div class="text-gray-500 text-extrabold text-sm">Name Here</div>
                            </div>
                ...
                <Link href="/" class="flex items-center justify-between max-w-[300px] pb-2">
                        <div class="flex items-center">
                            <img class="rounded-full z-10 w-[37px] h-[37px]" src="https://picsum.photos/id/54/300/320">
                            <div class="pl-4">
                                <div class="text-black font-extrabold">Name Here</div>
                                <div class="text-gray-500 text-extrabold text-sm">Name Here</div>
                            </div>
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">
                        ...
                        <br />
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo cupiditate eius minima esse.
