            ...
            <div class="flex items-center md:justify-between">
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        <div class="md:mr-6 mr-3 rounded-lg text-[22px]">Adrian Ospina</div>
                    ...
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            <div class="mr-6">
                                <span class="font-extrabold">6</span>  posts
                            </div>
                            <div class="mr-6">
                                <span class="font-extrabold">248</span>  followers
                            </div>
                            <div class="mr-6">
